...
**"As-Is" Disclaimer:**  
This technology is licensed exclusively on an **"As-Is" (En l'état)** basis. The author provides the compiled binaries and hardware Netlists fully verified according to the official Vivado synthesis reports and simulation waveforms hosted in this repository. Any custom port mappings, specific architecture adaptations, or ongoing engineering support requested by the licensee are strictly excluded and will be billed separately as dedicated engineering services.
